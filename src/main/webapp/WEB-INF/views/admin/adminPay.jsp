				...
				<div class="Area">
					<div class="memberArea">
						<div class="fromArea">
							...
							<tr class="searchbar">
								<td>
									<h2 class="MemberSearchMain">결제 내역 검색</h2>
									<hr>
								</td>
							</tr>
							<tr>
								<td class="MemberTitleArea"><span class="m1">번호</span> <span
									class="m2">회원아이디</span> <span class="m4">금액</span> <span
									class="m5">수량</span> <span class="m6">승인번호 </span> <span
									class="m3">결제일시</span>
							...
							<tr>
								<td colspan="6">
									<div class="MemberAreas">
										...
										<div class="mArea3">
											<span class="userName">1000</span>
										</div>
										<div class="mArea4">
											<span class="phone">7pass</span>
										</div>
										<div class="mArea5">
											<span class="email">shw123</span>
										</div>
										<div class="mArea6">
					...
					<div class="formArea2">
						...
						<div class="fromArea1">
							...
							<tr class="searchbar">
								<td>
									<h2 class="MemberSearchMain">pass 사용 이력</h2>
									<hr>
								</td>
							</tr>
							<tr>
								<td class="MemberTitleArea"><span class="m1">상호명</span> <span
									class="m2">아이디</span> <span class="m4A2">사용pass</span> <span
									class="m5A2">잔여pass	</span> <!-- <span class="m6A2">이메일 </span> <span
									class="m3A2">주소</span>
							...
							<tr>
								<td colspan="6">
									<div class="MemberAreas1">
										<div class="mArea">
											<span class="memberNum">김창희의헬스장</span>
										</div>
										<div class="mArea2">
											<span class="userId">shinhunwoo</span>
										</div>
										<div class="mArea3">
											<span class="userName">7pass</span>
										</div>
										<div class="mArea4">
											<span class="phone">15pass</span>
										</div>
										<!-- <div class="mArea5A2">
						...
						<div class="fromArea2">
							...
							<tr class="searchbar">
								<td>
									<h2 class="MemberSearchMain"> 환불 요청 이력</h2>
									<hr>
								</td>
							</tr>
							<tr>
								<td class="MemberTitleArea"><span class="m1">환불금액</span> <span
									class="m2">아이디</span> <span class="m4A2">요청날짜</span> <span
									class="m5A2">여부</span> <!-- <span class="m6A2">이메일 </span> <span
									class="m3A2">주소</span>
									 <span class="m7">결제이메일 </span>
									  <span class="m8">가입날짜 </span> -->
							...
							<tr>
								<td colspan="6">
									<div class="MemberAreas1">
										<div class="mArea">
											<span class="memberNum">7000</span>
										</div>
										<div class="mArea2">
											<span class="userId">shinhunwoo</span>
										</div>
										<div class="mArea3">
											<span class="userName">18-12-13</span>
										</div>
										<div class="mArea4">
											<span class="phone">'N'</span>
										</div>
										<!-- <div class="mArea5A2">
											<span class="email1">shinhunwoo@naver.com</span>
										</div>
