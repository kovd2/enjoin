...
.footer .companyInfo .companyURL, .footer .companyInfo p.contactList {
	opacity: 1;
}

.footer .companyInfo p.contactList .btn_applyPartner {
	color: #fff;
}
		...
		<div class="row">
			<div class="content col-md-12">
				<div class="page-header">
					<h2>
						시설이용내역 <small>얼마나 많은 사람이 이용했나 궁금하죠?</small>
					</h2>
				</div>
