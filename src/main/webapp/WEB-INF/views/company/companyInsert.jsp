											...
											<div class="row">
												<div class="col-md-4">
													<label>지역</label> <select class="form-control"	name="facilityArea" id="local" >
														...
														<option value="20">강원도</option>
														<option value="30">대전/충남</option>
														<option value="40">충청북도</option>
														<option value="50">대구/경북</option>
														<option value="60">전라북도</option>
														<option value="70">부산/울산/경남</option>
														<option value="80">전라남도</option>
												...
												<div class="col-md-4">
													...
													<select class="form-control" name="facilitySection" id="area_code00" required="">
														...
														<option value="11040">강서구</option>
														<option value="11050">관악구</option>
														<option value="11060">광진구</option>
														<option value="11070">구로구</option>
														<option value="11080">금천구</option>
														<option value="11090">노원구</option>
														<option value="11100">도봉구</option>
														<option value="11110">동대문구</option>
														<option value="11120">동작구</option>
														<option value="11130">마포구</option>
														<option value="11140">서대문구</option>
														<option value="11150">서초구</option>
														<option value="11160">성동구</option>
														<option value="11170">성북구</option>
														<option value="11180">송파구</option>
														<option value="11190">양천구</option>
														<option value="11200">영등포구</option>
														<option value="11210">용산구</option>
														<option value="11220">은평구</option>
														<option value="11230">종로구</option>
