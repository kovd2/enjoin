...
body.register .subWrap {
  /* 회원가입 배경화면 */
  background: #00bff0 url(resources/images/member/insertBackground2.jpg) no-repeat center center fixed;
...
<body class="register register2">
	...
	<div class="subWrap">
		...
		<header class="subHeader">
			<h1>
				<a href="goMain.me"><img src="resources/images/member/enjoin_logo_final.png"
					alt="Enjoin"></a>
			</h1>
		</header>

		<!--B2B 메일 도메인 선택이 가능함을 알리기 위한 화살표-->
			...
			<div class="memberWrap">
				<div class="row">
					<div
						...
						<h2>
							<span>좋아요!</span> <span>지금부터 <b>계정</b>을 만들게요!
							</span>
						</h2>
							...
							<div class="row">
								<div class="memberBox_left col-sm-6">
									...
									<div class="form-group bizAuthType" style="display: none;">
										<label>제휴기업 회원 가입 확인</label>
										<div>
											<label class="radio-inline"> <input type="radio"
												onclick="change_auth_type();" name="biz_auth_type"
												value="email" id="auth_type_email" checked> 회사 이메일
											</label>
										</div>
									</div>
									...
									<div class="form-group" id="user_email_div">
										...
										<div id="div_email_comp_desc"
											class="alert alert-info bizMemberAlert"
											style="display: none;">
											<h5>회사 이메일로 확인해 주세요.</h5>
											<p>
												입력하신 회사 이메일로 <strong>회원가입인증메일</strong>을 발송해 드립니다. 수신된 이메일의
												회원가입 인증링크를 확인해 주세요.
											</p>
										</div>
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">이름</label> <input
											onblur="check_validate(false);" type="text"
											class="form-control" placeholder="이름" name="userName"
											id="user_name" value=""> <span class="help-block"
											id="user_name_help"></span>
									</div>
								...
								<div class="memberBox_right col-sm-6">
									...
									<div class="form-group" id="user_phone_div">
										<label>휴대전화번호 </label>
										<p class="help-block">
											<span>전화번호를 '-'없이 입력하세요</span> 
											<span>ex)01012345678</span>
										</p>
										<input onblur="check_validate(false);" type="tel"
									...
									<!-- <div class="form-group" id="user_name_div">
										<label>추천인 아이디 입력하기</label>
										<p class="help-block">소개해 준 분의 아이디를 입력해 주세요. 없다면 비워두셔도
											됩니다.</p>
										<input type="text" class="form-control disabled"
											placeholder="추천인 아이디" name="present" id="present" value="">
									</div> -->
									<!-- 새 약관 동의 상자 -->
