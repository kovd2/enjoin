...
.forBizMemberAnc .btn_BizMemberAnc {
	display: inline-block;
	margin-top: 10px;
	color: #fff;
	padding: 7px 30px;
...
.forBizMemberAnc .btn_BizMemberAnc:hover {
	color: #00bff0;
	border-color: #fff;
	background: #fff;
	text-decoration: none;
...
.register_type_select .via_facebook {
	background: #3b5998;
	color: #fff;
}
...
.register_type_select .via_naver {
	background: #1ec800;
	color: #fff;
}

.register_type_select .via_email {
	background: #00bff0;
	color: #fff;
}
...
.register_type_select .divLine span {
	display: inline-block;
	padding: 5px 20px;
	top: -18px;
	position: relative;
...
/* 회원가입 - 새 약관 동의 상자 070202 sjHyeong */
.registerAgreementBox {
	
}

.registerAgreementBox .panel-heading {
	padding-bottom: 0;
}

.registerAgreementBox .panel-heading .panel-title {
	font-size: 12px;
	letter-spacing: -0.5px;
}

.registerAgreementBox .panel-heading label {
	font-size: 13px;
	font-weight: 400;
}

.registerAgreementBox .panel-body {
	padding-top: 0;
	padding-bottom: 0;
}
...
.memberForm .memberBox_right .registerAgreementBox .form-group {
	margin: 0;
}

.registerAgreementBox .panel-body p.help-block {
	margin-left: 20px;
	font-size: 11px;
}

.registerAgreementBox .panel-body label {
	color: #555;
	font-weight: 400;
}

.registerAgreementBox .panel-body label a {
	color: #555;
	text-decoration: underline;
}

.memberForm .submitLine {
	margin-top: 40px;
	position: relative;
}

.memberPersonalInfoForm .submitLine {
	margin-top: 20px;
}
...
.submitLine .btn-signup:hover {
	background: #0E2036;
}

.memberPersonalInfoForm .submitLine .btn-signup {
	margin: 0 0 30px;
}

.memberForm h5.help-block {
	font-size: 13px;
	color: #00bff0;
}
...
.btnWrap_YesOrNo a.btn_yes {
	background: #00bff0;
	color: #fff;
}

.btnWrap_YesOrNo a.btn_no {
	border: 1px solid #eee;
	margin-left: 10px;
	color: #aaa;
}

.btnWrap_YesOrNo a:hover {
	background: #0E2036;
}

.btnWrap_YesOrNo a.btn_no:hover {
	color: #fff;
	border-color: #0E2036;
}
...
.familyUserInfoBox .userInfo h6 {
	font-size: 14px;
	color: #555;
}

.familyUserInfoBox .userInfo h6 strong.userId {
	display: block;
}

.familyUserInfoBox .userInfo h6 span.userName {
	display: block;
	font-size: 12px;
	font-weight: 400;
}
...
.memberBox .userProfilePicBox {
	text-align: center;
}

.memberBox .userProfilePicBox .picWrap {
	position: relative;
	display: inline-block;
	width: auto;
}

.memberBox .userProfilePicBox img {
	width: 128px;
	height: 128px;
	border-radius: 50%;
	display: block;
...
.memberPersonalInfoForm .form-control {
	height: 40px;
	font-size: 13px;
	margin-bottom: 2px;
}

.memberPersonalInfoForm .birthdateSelect .input-group-addon {
	font-size: 12px;
	padding: 0 5px;;
}

/* 공무원증·재직증명서 예시이미지 썸네일스타일 */
.thumbnailbox .grid {
	display: grid;
...
.thumbnailbox .thumbnails {
	list-style: none;
	margin: 0;
	padding: 0;
}

.thumbnailbox .thumbnails li {
	margin: 2px;
	position: relative;
	border-radius: 2px;
	min-height: 100px;
...
.thumbnailbox .thumbnails li img {
	max-width: 100%;
	border-radius: 4px;
	border: 1px solid #bdbdbd;
}

.thumbnailbox .thumbnails span {
	display: inline-block;
	width: 100%;
	font-size: 11px;
	padding: 8px 0;
...
<body class="register register2">
	...
	<div class="subWrap">
		...
		<div class="container companyRegister">
			<div class="memberWrap">
				<div class="row">
					<div
						class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-offset-0 col-sm-12 memberBox">

						<h2>
							<span>좋아요!</span> <span>지금부터 <b>제휴시설</b> 정보를 입력해서 <b>계정</b>을
								만들게요!
							</span>
						</h2>
						...
						<form name="form_register" class="memberForm" method="post" id="CompanyMemberJoin" action="companyInsert.me">
							...
							<input type="hidden" name="next" id="next" value=""> <input
								type="hidden" name="from" id="from" value=""> <input
								type="hidden" name="r" value=""> <input type="hidden"
								name="checkphone" value="">
							...
							<div class="row">
								<div class="memberBox_left col-sm-6">
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">담당자 이름</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">담당자 전화번호</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
												onblur="check_validate(false);" type="text"
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">담당자 이메일</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
												onblur="check_validate(false);" type="text"
							...
							<div class="memberBox_right col-sm-6">
								...
								<div class="form-group" id="user_name_div">
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">대표자이름</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
												onblur="check_validate(false);" type="text"
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">시설주소</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
												onblur="check_validate(false);" type="text"
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">사업자 등록번호</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
												onblur="check_validate(false);" type="text"
									...
									<div class="form-group" id="user_name_div">
										<label class="sr-only">전자세금계산서용 이메일</label>
										<div class="floatlabel-wrapper" style="position: relative">
											<label for="user_name" class="label-floatlabel  "
												style="position: absolute; top: 0px; left: 0px; display: none; opacity: 0; font-size: 11px; font-weight: 600; color: rgb(153, 153, 153); transition: all 0.1s ease-in-out 0s;">이름</label><input
								...
								<div class="form-group" id="user_phone_div">
									<label>휴대전화번호</label>
									<p class="help-block">
										<span>전화번호를 '-'없이 입력하세요</span> <span>ex)01012345678</span>
									</p>
									<div class="floatlabel-wrapper" style="position: relative">
										<label for="user_phone" class="label-floatlabel  "
								...
								<!-- 새 약관 동의 상자 -->
								<div class="panel panel-default registerAgreementBox">
										<div class="panel-heading">
											<h3 class="panel-title">약관 동의</h3>
											<div class="checkbox">
												<label> <input type="checkbox" id="checkAll"
													value=""> 아래 약관에 모두 동의 합니다.
												</label>
											</div>
										</div>
										<div class="panel-body">
											<div class="form-group" id="terms_agreement_div">
												...
												<span class="help-block" id="terms_agreement_help"></span>
											</div>
											<div class="form-group" id="privacy_agreement_div">
												...
												<span class="help-block" id="privacy_agreement_help"></span>
											</div>
