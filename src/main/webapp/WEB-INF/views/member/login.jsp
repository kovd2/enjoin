							...
							<div class="row">
								<div class="memberBox_left col-sm-6">
									<div class="register_type_select">
										...
										<a href="/member/login_kakao/?next=%2F"
											onclick="loginWithKakao();return false;"
											class="via_kakaotalk"><img class="ico"
											src="resources/images/member/kakao.png" alt=""> <b>카카오톡</b>으로
											로그인</a>
								...
								<div class="memberBox_right col-sm-6">
									...
									<div class="forgot">
										아이디, 비밀번호가 생각나지 않으세요?<br> <a href="/member/find_id/">아이디
											찾기</a>&nbsp;&nbsp;&nbsp;&nbsp; <a
											href="/member/reset_pw/?user_id=">비밀번호 찾기</a>
									</div>
								</div>
								<!-- ./memberBox_right -->
							</div>
